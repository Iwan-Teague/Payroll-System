...
public class PayslipGenerator {
    ...
    // Gets all necessary information about each employee from the employee.EmployeeSalary class
    ...
    private String[] getPartTimeHours(String ppsNo) {
        ...
        List<String[]> partTimeDetails = new SimpleCSVReader().readCsvPayScale(3, "csv/csv files/PartTime.csv");
